		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10">
					...
					foreach ($this->data['data'] as $family_industries) {
						$id= $family_industries["id"];
						$name= $family_industries["name"];
						$counter++;		
						$number++;			
						...
						if($counter==3 || $counter==9 || $counter==15 || $counter==21 || $counter==27){
							echo "<li style='background:#".$background_colors[$number-1].";'>
									...
									<a href='".$GLOBALS["root"]."categoria-industrias/".$id."' alt='".$name."'><span>".$name."</span></a>
								  </li>
								  <li style='background:white;'><a href='#'></a></li>
								  <li style='background:white;'><a href='#'></a></li>";			
						}
						else if($counter==6 || $counter==12 || $counter==18 || $counter==24 || $counter==30){
							echo "<li style='background:#".$background_colors[$number-1].";'><span class='number'>".$number."</span><a href='".$GLOBALS["root"]."categoria-industrias/".$id."' alt='".$name."'><span>".$name."</span></a></li>";	
						}else{
							echo "<li style='background:#".$background_colors[$number-1].";'><span class='number'>".$number."</span><a href='".$GLOBALS["root"]."categoria-industrias/".$id."' alt='".$name."'><span>".$name."</span></a></li>
								  <li style='background:white;'><a href='#'></a></li>";				
						}							
